<?php 
  ...
  if(isset($_POST['register'])) {
    ...
    $status_ssc = clean($_POST['status']);
    $status_teatro = clean($_POST['status']);
    $status_itso = clean($_POST['status']);
    $status_jpia = clean($_POST['status']);
    $status_ops = clean($_POST['status']);
    ...
    if(mysqli_num_rows($result) == 0) {
      ...
      if(mysqli_num_rows($result) == 0) {
        ...
        $query = "INSERT INTO students (username, password, studentno, firstname, lastname, email, course, yrlevel, access, vote_status_ssc, vote_status_teatro, vote_status_itso, vote_status_jpia, vote_status_ops, date_joined)
        VALUES ('$uname', '$pword', '$studno', '$fname', '$lname', '$email', '$course', '$yrlevel', '$access', '$status_ssc', '$status_teatro', '$status_itso', '$status_jpia', '$status_ops', NOW())";
          ...
          <div class="personal-info col-sm-6">
            ...
            <fieldset>
              ...
              <div class="form-group">
                ...
                <input type="text" class="form-control" name="email" placeholder="Email" accept=".com"required>
              </div>
