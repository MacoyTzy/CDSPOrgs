	...
	<body>
		...
		<!-- Header -->
			<section id="header">
				...
				<nav id="nav">
					<ul>
						<li><a href="#one" class="active">JPIA</a></li>
						...
						<!-- One -->
							<section id="one">
								<div class="container">
									...
									<p style="text-align:justify">Is an academic organization that helps the BSA students to excel and develop their skills in the academic aspect.  </br><a href="jpia.php" target="_blank">View more...</a></p>
<								</div>
							</section>
