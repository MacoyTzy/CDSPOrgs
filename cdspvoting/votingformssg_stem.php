<?php 
  ...
  if (isset($_SESSION['Status_shs']) && $_SESSION['Status_shs'] == "Free") {
    echo "";
  } else {
  ...
  if(isset($_POST['register'])) {
    ...
    $selection_stem = clean($_POST['selectionstem']);
    //$selection_abm = clean($_POST['selectionabm']);
   // $selection_gas =clean($_POST['selectiongas']);
    //$selection_humss = clean($_POST['selectionhumss']);
   // $selection_ict = clean($_POST['selectionict']);
   //  $selection_he = clean($_POST['selectionhe']);
    ...
    if(isset($_SESSION['Studentno']) && $_SESSION['Studentno'] == "$studno") {
      ...
      $query = "SELECT studentno FROM shs_votes WHERE studentno = '$studno'";
      $result = mysqli_query($con,$query);

       if(mysqli_num_rows($result) == 0) 
       {

        $query = "INSERT INTO shs_votes (studentno, firstname, lastname, voteforshspres, voteforshsvpres, voteforshssec, voteforshstres, voteforshspro, voteforshssgtarms, voteforshsstem)
        VALUES ('$studno', '$fname', '$lname', '$selection_pres', '$selection_vpres', '$selection_sec', '$selection_tres', '$selection_pro', '$selection_saa', '$selection_stem')";


        if(mysqli_query($con, $query)) 
        {
          $status = clean($_POST['status']);
          $query = "UPDATE students SET vote_status_shs = '$status' WHERE studentno = '$stud'";
          ...
          { die("Error with the shs_votes query"); }
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            ...
            <div class="">
          <?php
          $sql = "SELECT * from candidates WHERE candid_position = 'President' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ?>
              <?php do{ ?>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            ...
            <div class="">
          <?php
          $sql = "SELECT * from candidates WHERE candid_position = 'Vice President' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ?>
              <?php do{ ?>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Secretary' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Treasurer' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Public Relation Officer' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Sgt. at Arms' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            <br>
            <h3 class="normalFont">STEM Representative</h3>
            <div class="">
          <?php
          
          $sql = "SELECT * from candidates WHERE candid_position = 'STEM Representative' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionstem" value="<?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
