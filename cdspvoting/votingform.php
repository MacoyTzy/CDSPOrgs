    ...
    if(isset($_SESSION['Studentno']) && $_SESSION['Studentno'] == "$studno") {
      ...
      $result = mysqli_query($con,$query);
       ...
       if(mysqli_num_rows($result) == 0) 
       {
        ...
        $query = "INSERT INTO ssc_votes (studentno, firstname, lastname, voteforsscpres, voteforsscvpres, voteforsscsec, voteforssctres, voteforsscpro, voteforsscsgtarms, voteforsscbsoarep, voteforsscbsarep, voteforsscbsitrep)
        VALUES ('$studno', '$fname', '$lname', '$selection_pres', '$selection_vpres', '$selection_sec', '$selection_tres', '$selection_pro', '$selection_saa', '$selection_bsoarep', '$selection_bsarep', '$selection_bsitrep')";


        if(mysqli_query($con, $query)) 
        {
          $status = clean($_POST['status']);
          $query = "UPDATE students SET vote_status = '$status' WHERE studentno = '$stud'";
          ...
          {
               $_SESSION['errprompt'] = "You are already Voted.";
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              <?php do{ ?>
              <label for="">
                <input type="radio" name="selectionpres" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              <?php do{ ?>
              <label for="">
                <input type="radio" name="selectionvpres" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionsec" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectiontres" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionpro" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionsaa" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            <br>
            <h3 class="normalFont">BSOA Representative</h3>
            <div class="">
          <?php
          
          $sql = "SELECT * from candidates WHERE candid_position = 'BSOA Representative' AND candid_org = 'SSC'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionbsoarep" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionbsarep" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            <br>
            <h3 class="normalFont">BSIT Representative</h3>
            <div class="">
          <?php
          
          $sql = "SELECT * from candidates WHERE candid_position = 'BSIT Representative' AND candid_org = 'SSC'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionbsitrep" value="<?php echo $row['studentno'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
