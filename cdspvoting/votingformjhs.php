<?php 
  ...
  if (isset($_SESSION['Status_jhs']) && $_SESSION['Status_jhs'] == "Free") {
    echo "";
  } else {
  ...
  if(isset($_POST['register'])) {
    ...
    if(isset($_SESSION['Studentno']) && $_SESSION['Studentno'] == "$studno") {
      ...
      $query = "SELECT studentno FROM jhs_votes WHERE studentno = '$studno'";
      $result = mysqli_query($con,$query);

       if(mysqli_num_rows($result) == 0) 
       {

        $query = "INSERT INTO jhs_votes (studentno, firstname, lastname, voteforjhspres, voteforjhsvpres, voteforjhssec, voteforjhstres, voteforjhsaud, voteforjhspro, voteforjhssaa)
        ...
        if(mysqli_query($con, $query)) 
        {
          ...
          $query = "UPDATE students SET vote_status_jhs = '$status' WHERE studentno = '$stud'";
          ...
          { die("Error with the jhs_votes query"); }
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            ...
            <div class="">
          <?php
          $sql = "SELECT * from candidates WHERE candid_position = 'President' AND candid_org = 'JHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ?>
              <?php do{ ?>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            ...
            <div class="">
          <?php
          $sql = "SELECT * from candidates WHERE candid_position = 'Vice President' AND candid_org = 'JHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ?>
              <?php do{ ?>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Secretary' AND candid_org = 'JHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Treasurer' AND candid_org = 'JHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Public Relation Officer' AND candid_org = 'JHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Sgt. at Arms' AND candid_org = 'JHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
