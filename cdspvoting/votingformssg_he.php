    ...
    if(isset($_SESSION['Studentno']) && $_SESSION['Studentno'] == "$studno") {
      ...
      $result = mysqli_query($con,$query);
       ...
       if(mysqli_num_rows($result) == 0) 
       {
        ...
        $query = "INSERT INTO shs_votes (studentno, firstname, lastname, voteforshspres, voteforshsvpres, voteforshssec, voteforshstres, voteforshspro, voteforshssgtarms, voteforshshe)
        VALUES ('$studno', '$fname', '$lname', '$selection_pres', '$selection_vpres', '$selection_sec', '$selection_tres', '$selection_pro', '$selection_saa', '$selection_he')";
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            <br>
            <h3 class="normalFont">HE Representative</h3>
            <div class="">
          <?php
          
          $sql = "SELECT * from candidates WHERE candid_position = 'HE Representative' AND candid_org = 'SHS'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionhe" value="<?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
