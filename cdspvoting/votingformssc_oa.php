    ...
    if(isset($_SESSION['Studentno']) && $_SESSION['Studentno'] == "$studno") {
      ...
      $result = mysqli_query($con,$query);
       ...
       if(mysqli_num_rows($result) == 0) 
       {
        ...
        $query = "INSERT INTO ssc_votes (studentno, firstname, lastname, voteforsscpres, voteforsscvpres, voteforsscsec, voteforssctres, voteforsscpro, voteforsscsgtarms, voteforsscbsoarep)
        VALUES ('$studno', '$fname', '$lname', '$selection_pres', '$selection_vpres', '$selection_sec', '$selection_tres', '$selection_pro', '$selection_saa', '$selection_bsoarep')";
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          ?>
              ...
              <label for="">
                <input type="radio" name="selectionbsoarep" value="<?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?>"> <strong><?php echo $row['candid_fname'];?> <?php echo $row['candid_lname'];?></strong>
              </label><br>
