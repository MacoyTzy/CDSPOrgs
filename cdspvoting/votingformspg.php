...
<?php 
  ...
  if (isset($_SESSION['Status_elem']) && $_SESSION['Status_elem'] == "Free") {
    echo "";
  } else {
  ...
  if(isset($_POST['register'])) {
    ...
    if(isset($_SESSION['Studentno']) && $_SESSION['Studentno'] == "$studno") {
      ...
      $query = "SELECT studentno FROM elem_votes WHERE studentno = '$studno'";
      $result = mysqli_query($con,$query);

       if(mysqli_num_rows($result) == 0) 
       {

        $query = "INSERT INTO elem_votes (studentno, firstname, lastname, voteforelempres, voteforelemvpres, voteforelemsec, voteforelemtres, voteforeleaud, voteforelempro, vvoteforelemsaa)
        VALUES ('$studno', '$fname', '$lname', '$selection_pres', '$selection_vpres', '$selection_sec', '$selection_tres', '$selection_pro', '$selection_saa')";


        if(mysqli_query($con, $query)) 
        {
          $status = clean($_POST['status']);
          $query = "UPDATE students SET vote_status_elem = '$status' WHERE studentno = '$stud'";
          ...
          { die("Error with the elem_votes query"); }
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            ...
            <div class="">
          <?php
          $sql = "SELECT * from candidates WHERE candid_position = 'President' AND candid_org = 'ELEM'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ?>
              <?php do{ ?>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          <div class="">
            ...
            <div class="">
          <?php
          $sql = "SELECT * from candidates WHERE candid_position = 'Vice President' AND candid_org = 'ELEM'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
          ?>
              <?php do{ ?>
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Secretary' AND candid_org = 'ELEM'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Treasurer' AND candid_org = 'ELEM'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Public Relation Officer' AND candid_org = 'ELEM'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
...
<!-- ///////////////////////////////////////////////////////////////////////////////////////////// -->
          ...
          $sql = "SELECT * from candidates WHERE candid_position = 'Sgt. at Arms' AND candid_org = 'ELEM'";
          $students = $con->query($sql) or die ($con->error);
          $row = $students->fetch_assoc();
